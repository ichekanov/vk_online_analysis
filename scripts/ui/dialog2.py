...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog, mainwindow, connection):
        ...
        self.radioButton_3.setEnabled(False)  # TODO: Открыть когда появятся новые графики
        ...
        self.pushButton_4.setEnabled(False) # TODO: Открыть когда появятся новые графики
        self.pushButton_4.clicked.connect(self.openChooseUsers)  # Тут должен быть выбор платформ
        self.verticalLayout.addWidget(self.pushButton_4)
        self.radioButton_4 = QtWidgets.QRadioButton(Dialog)
        self.radioButton_4.setObjectName("radioButton_4")
        self.radioButton_4.setEnabled(False)  # TODO: Открыть когда появятся новые графики
